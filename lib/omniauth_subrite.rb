...
module ::OmniAuth
  ...
  module Strategies
    class Subrite < OmniAuth::Strategies::OAuth2
      ...
      def discover!
        ...
        if discovery_document.nil?
          raise ::OmniAuth::Subrite::DiscoveryError.new("Discovery document is missing")
        end
        ...
        discovery_params.each do |internal_key, external_key|
          ...
          if val.nil? || val.empty?
            raise ::OmniAuth::Subrite::DiscoveryError.new(
      ...
      extra do
        ...
        hash[:user_type] = member_info["userType"] || "member"
...
OmniAuth.config.add_camelization "subrite", "Subrite"
